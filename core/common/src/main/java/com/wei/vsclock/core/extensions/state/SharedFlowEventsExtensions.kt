package com.wei.vsclock.core.extensions.state
...
private const val DEPRECATED_MESSAGE =
    "Google 官方明確表示不適合使用 Channels, SharedFlow 或其他回應式串流向 UI 公開 ViewModel 事件。\n" +
        ...
        "如要進一步瞭解部分程式碼範例不應使用上述 API 的原因，\n" +
        "請閱讀「ViewModel：單次活動反模式」 (https://medium.com/androiddevelopers/viewmodel-one-off-event-antipatterns-16a1da869b95) 這篇網誌文章。"
